...
def header():
    ...
    st.markdown("**Студент:** Василий Макисмович Ткаченко")
    st.markdown("**Руководитель ВКР:** к.т.н., доцент Рудаков Игорь Владимирович")

    st.sidebar.markdown("# Опасность рядом.")
    st.sidebar.markdown("""
    ...
    """)
    st.sidebar.markdown("[project repo](https://github.com/Basilt69/bmstu_BGQW)")
